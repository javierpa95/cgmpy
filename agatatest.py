...
metricas_comparacion = {
    ...
    'LBGI': {
        'py_agata': resultados['risk']['lbgi'],
        'cgmpy': resultados_cgmpy['lbgi']
    },
    'HBGI': {
        'py_agata': resultados['risk']['hbgi'],
        'cgmpy': resultados_cgmpy['hbgi']
    },
    'ADRR': {
        'py_agata': resultados['risk']['adrr'],
        'cgmpy': resultados_cgmpy['adrr']
    },
    'GRI': {
        'py_agata': resultados['risk']['gri'],
        'cgmpy': resultados_cgmpy['gri']
    },
    'MAGE': {
