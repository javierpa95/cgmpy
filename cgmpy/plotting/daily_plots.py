...
class DailyPlotter:
    ...
    def day_graph(self, fecha: Optional[str] = None):
        ...
        ax.plot(day_data['hours'], day_data['glucose'], 
               label='Glucosa', color='#3366CC', linewidth=2, 
    ...
    def plot_overlapping_days(self):
        ...
        data_copy['time_decimal'] = (data_copy['time'].dt.hour + 
                                    data_copy['time'].dt.minute / 60.0)
        ...
        mean_profile = (data_copy.groupby('time_decimal')['glucose']
                       .mean()
    ...
    def plot_week_boxplots(self):
        ...
        # Crear el boxplot
        sns.boxplot(x='weekday', y='glucose', data=data_copy, 
                    order=orden_dias,
                    whis=1.5,
    ...
    def plot_daily_variations(self):
        ...
        hourly_stats = data_copy.groupby('time_decimal')['glucose'].agg([
            'mean', 'std', 'count',
        ...
        for col in ['mean', 'std', 'p25', 'p75']:
            hourly_stats[col] = hourly_stats[col].rolling(
        ...
        ax.plot(hourly_stats['time_decimal'], hourly_stats['mean'], 
               color='blue', linewidth=2, label='Media')
        
        # Banda de desviación estándar
        ax.fill_between(hourly_stats['time_decimal'],
        ...
        ax.fill_between(hourly_stats['time_decimal'],
                       hourly_stats['p25'],
                       hourly_stats['p75'],
                       alpha=0.2, color='green', label='Rango intercuartil')
